...
class Parameters():
    ...
    def __init__(self):
        ...
        self.numaxG = 3.9872          # max consumption rate of glucose (1.0005)  h^-1       [1]
        ...
        ## 14. HAc UPTAKE RATE.
        self.numaxHAc = 0.0443*0.001     # max uptake rate of HAc                    h^-1       [2]
        ...
        self.KiGlu = 5                # inhibition constant of Glu to Xyl         g/L        Unknown
        # p(36) = KiGlu;
